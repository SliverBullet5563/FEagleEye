...
//修改包名
char* lib_path = "/data/data/com.example.feagleeye/lib/libeagleeyenative.so";

LIB_HOOK_INFO_NODE* custom_lib_hook_info_root = NULL;
HOOKED_INFO_NODE* hooked_info_root = NULL;

JNIEXPORT void JNICALL
Java_com_example_feagleeye_NativeEntry_initSystemNativeHook( JNIEnv* env, jobject this )
{
...
JNIEXPORT void JNICALL
Java_com_example_feagleeye_NativeEntry_initCustomNativeHook(JNIEnv* env, jobject this, jstring lib_name){
